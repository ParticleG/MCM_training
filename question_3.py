...
header_list = ["Total population", "Group size", "Next population", "Next infection rate", "Negative rate", "Check counts"]
output_list = []
...
def check_disease(_total_population, _infection_rate, _previous_group_size,
    ...
    _next_population = _total_population * (Dec(1) - (
            (Dec(1) - (_false_positive_rate + _recessive_rate + (Dec(1) - _negative_rate) / _negative_rate * _false_negative_rate)) * _negative_rate
    ))
    _next_infection_rate = _total_population / _next_population * _infection_rate
    ...
    print(f"_total_population={_total_population}, "
          ...
          f"_negative_rate={_negative_rate}, "
...
if __name__ == "__main__":
    ...
    first_time = True
    file_name = f'Q3_{total_population}_{infection_rate}_{false_negative_rate}_{false_positive_rate}_{recessive_rate}.csv'
    while True:
        ...
        next_population, next_infection_rate, temp_check_counts, group_size = check_disease(
